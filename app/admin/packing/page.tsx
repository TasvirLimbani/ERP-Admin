...
export default function PackingPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Packing</h1>
        <p className="text-muted-foreground mt-1">
          Manage packing process and shipments
        </p>
      </div>
      ...
      <ItemModal
        isOpen={isModalOpen}
        title={editingItem ? "Edit Packing Batch" : "Add New Packing Batch"}
        fields={formFields}
