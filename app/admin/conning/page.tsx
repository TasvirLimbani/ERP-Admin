...
export default function ConningPage() {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-3xl font-bold text-foreground">Conning</h1>
        <p className="text-muted-foreground mt-1">
          Manage conning process and cone production
        </p>
      </div>
      ...
      <ItemModal
        isOpen={isModalOpen}
        title={editingItem ? "Edit Conning Batch" : "Add New Conning Batch"}
        fields={formFields}
